...
@section('title', 'Logout | Cinema')

@section('content')
<div class="relative min-h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('{{ asset('img/logout.png') }}');">
    <div class="absolute inset-0 bg-black opacity-60"></div>

    <div class="relative p-10 w-full max-w-md text-center mt-[-6%]">
        <h2 class="text-2xl font-bold mb-2 text-white">Logged out successfully!</h2>
        <p class="text-lg mb-4 text-white"><em>Please login again to access your account</em></p>
        ...
        <form action="{{ route('login_post') }}" method="POST" class="space-y-6">
            ...
            <div class="relative">
                ...
                <input type="text" name="email" id="email" placeholder="Email" 
                       class="w-full bg-white bg-opacity-10 text-white border-none rounded-full py-3 px-10 placeholder-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300 shadow-lg"
